package com.cursojava.mongodbspringboot.config;
...
import com.cursojava.mongodbspringboot.dto.AuthorDTO;
import com.cursojava.mongodbspringboot.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1= new Post(null, sdf.parse("21/03/2018"), "Partiu viagem"	, "Vou viajar pars São Paulo, abraços!", new AuthorDTO(maria));
